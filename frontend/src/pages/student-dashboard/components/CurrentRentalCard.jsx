      ...
      <div className="flex flex-col sm:flex-row gap-4 p-4">
        ...
        <div className="flex-1 flex flex-col justify-between min-w-0">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-3">{rental?.author}</p>
            ...
            <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium ${getStatusColor()}`}>
              <Icon name={daysRemaining < 0 ? "AlertCircle" : "Clock"} size={14} />

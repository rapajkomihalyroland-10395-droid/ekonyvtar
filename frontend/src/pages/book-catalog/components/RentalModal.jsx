        ...
        <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-1 pt-1">
                {[...Array(5)]?.map((_, index) => (
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke={index < Math.floor(book?.rating) ? '#F59E0B' : '#71717a'}
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className={index < Math.floor(book?.rating) ? 'fill-current text-[#F59E0B]' : 'text-muted-foreground'}
                  >
          ...
          <div className="p-4 bg-warning/10 border border-warning/20 rounded-lg">
            <div className="flex gap-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-warning flex-shrink-0 mt-0.5">
